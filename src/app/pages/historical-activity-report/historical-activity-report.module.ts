...
import { HistoricalActivityReportRoutingModule } from './historical-activity-report.routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    HistoricalActivityReportRoutingModule,
    MaterialModule,
    FurySharedModule,
    ReactiveFormsModule,
...
export class HistoricalActivityReportModule { }
